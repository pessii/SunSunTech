        ...
        <div class="accordion">
            <div class="accordion-container">
                ...
                <div class="product-side-sale-search accordion-item">
                    ...
                    <div class="product-side-sale-search-checkbox accordion-content">
                ...
                <div class="product-side-item-search accordion-item">
                    ...
                    <div class="product-side-item-search-checkbox accordion-content">
                        <label class="ECM_CheckboxInput">
                ...
                <div class="product-side-brand-search accordion-item">
                    ...
                    <div class="product-side-brand-search-checkbox accordion-content">
                        <label class="ECM_CheckboxInput">
                ...
                <div class="product-side-concern-search accordion-item">
                    ...
                    <div class="product-side-concern-search-checkbox accordion-content">
                        <label class="ECM_CheckboxInput">
                ...
                <div class="product-side-personal-color accordion-item">
                    ...
                    <div class="product-side-personal-color-checkbox accordion-content">
                        <label class="ECM_CheckboxInput">
